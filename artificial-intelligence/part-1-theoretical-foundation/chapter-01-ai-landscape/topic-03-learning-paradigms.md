...
* Supervised and unsupervised algorithms are the substance of **Classical Machine Learning** — the very next topic, then studied deeply in **Chapter 7** and implemented from scratch in **Part 2**.
...
* Reinforcement learning learns behavior through trial, error, and reward — no pre-existing dataset.
